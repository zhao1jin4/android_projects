...
import org.zhaojin.widgetUI.fragememt.listFragment.FragmentLayout;
import org.zhaojin.widgetUI.fragement.tab.FragmentTabs;
import org.zhaojin.widgetUI.layout.ActivityMain;
import org.zhaojin.widgetUI.listview.ListViewMain;
import org.zhaojin.widgetUI.menu.MenuMain;
...
public class MainActivity extends Activity {
	...
	private void find_and_modify_button() {
		...
		hcrollViewButton.setOnClickListener(new Button.OnClickListener()
		{
			...
			{
				Intent intent = new Intent();
				intent.setClass(MainActivity.this,  org.zhaojin.widgetUI.hscroll.HScrollActivity.class);
				startActivity(intent);
			}
		});
