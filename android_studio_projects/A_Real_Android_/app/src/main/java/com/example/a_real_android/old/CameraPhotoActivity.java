package com.example.a_real_android.old;
...
public class CameraPhotoActivity extends Activity {
	...
	//android.hardware.Camera 过时，用android.hardware.camera2包
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		System.out.println(CameraPhotoActivity.this.getCacheDir());//在模拟器上和真机上路径变为 /data/user/0/<package>/cache
//		Uri outputFileUri = Uri.fromFile(new File( CameraPhotoActivity.this.getCacheDir(),"myImg.png"));// 报 FileUriExposedException 错

		//未成功
		File file=new File(CameraPhotoActivity.this.getCacheDir(),"myImg.png");
		Uri outputFileUri =FileProvider.getUriForFile(this.getApplicationContext(), "com.example.a_real_android.provider", file);//authority对应xml中的
